...
- type：string / path / select（options 支持 {value,label}）/ boolean / tags / number
...
def validate_module_settings(schema: list | None, submitted: dict | None) -> tuple[bool, dict, list[str]]:
    """校验并清洗提交的 settings。
